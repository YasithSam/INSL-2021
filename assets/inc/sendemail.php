...
define( "RECIPIENT_NAME", "INSL Team" );
define( "RECIPIENT_EMAIL", "inslpublicity@gmail.com" );
...
if ( $name && $senderEmail && $message ) {
  ...
  echo "<div class='inner success'><p class='success'>Thank you for contacting INSL Team. We will contact you ASAP!</p></div><!-- /.inner -->";
}else {
